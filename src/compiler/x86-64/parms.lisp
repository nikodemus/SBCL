...
(progn
  ...
  (def!constant default-dynamic-space-start #x1000000000)
  (def!constant default-dynamic-space-end
      ;; This is lower on OpenBSD to allow SBCL to run under the
      ;; default 512M data size limit.
      (!configure-dynamic-space-end #!+openbsd #x101bcf0000))
